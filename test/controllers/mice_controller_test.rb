...
class MiceControllerTest < ActionController::TestCase
  ...
  test "should create mouse" do
    assert_difference('Mouse.count') do
      post :create, mouse: { dob: @mouse.dob, genotype: @mouse.genotype, number: @mouse.number, sex: @mouse.sex }
    end
  ...
  test "should update mouse" do
    patch :update, id: @mouse, mouse: { dob: @mouse.dob, genotype: @mouse.genotype, number: @mouse.number, sex: @mouse.sex }
    assert_redirected_to mouse_path(assigns(:mouse))
  end
